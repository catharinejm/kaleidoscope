...
define i32 @_Z4funcR1B(%class.B* %a) #0 {
entry:
  %a.addr = alloca %class.B*, align 8
  store %class.B* %a, %class.B** %a.addr, align 8
  %0 = load %class.B** %a.addr, align 8
  %call = call i32 @_ZN1B3subEi(%class.B* %0, i32 10)
  %1 = load %class.B** %a.addr, align 8
  %2 = bitcast %class.B* %1 to i32 (%class.B*, i32)***
  %vtable = load i32 (%class.B*, i32)*** %2
  %vfn = getelementptr inbounds i32 (%class.B*, i32)** %vtable, i64 0
  %3 = load i32 (%class.B*, i32)** %vfn
  %call1 = call i32 %3(%class.B* %1, i32 40)
  ret i32 %call1
}

; Function Attrs: nounwind ssp uwtable
define linkonce_odr i32 @_ZN1B3subEi(%class.B* %this, i32 %y) #1 align 2 {
entry:
...
; Function Attrs: ssp uwtable
define linkonce_odr void @_ZN1BC2Ei(%class.B* %this, i32 %i) unnamed_addr #0 align 2 {
entry:
  %this.addr = alloca %class.B*, align 8
  %i.addr = alloca i32, align 4
  store %class.B* %this, %class.B** %this.addr, align 8
